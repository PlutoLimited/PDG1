...
namespace runnable
{
    namespace ledc
    {
        ...
        void CLEDCRunnable::attachInputPorts(llcPort_p f_llcInputPort, ticPort_p f_ticInputPort)
        {
        ...
        {
            auto llcData = *(m_llcInputPort->getData());
            llcData.m_dimLevel = llcData.m_dimLevel + 1;
            m_llcInputPort->setData(llcData);
        }

        void CLEDCRunnable::sendOutput()
        {
            m_ledcOutputPort->setData(m_output);
        }
