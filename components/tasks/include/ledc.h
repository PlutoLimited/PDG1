...
namespace tasks
{
    namespace ledc
    {
        ...
        {
        public:
            explicit LEDCTask() : smooth::core::Task("TASK::LEDC", 9000, smooth::core::APPLICATION_BASE_PRIO, std::chrono::milliseconds{20}), m_ticInputPort(), m_llcInputPort(), m_ledcOutputPort(), m_ledcRunnable(), m_logCounter(0U)
            {
            }
